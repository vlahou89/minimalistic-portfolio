...
function ContactSection() {
  return (
    <div>
      <div className="flex flex-col items-center md:flex-row md:justify-between mt-24  pb-16">
        ...
        <div className="hidden sm:w-10 md:w-40 lg:w-40 xl:w-half mx-8 border-b opacity-25 md:block border-p3" />
